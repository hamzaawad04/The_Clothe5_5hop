...
Ensure SQL and Apache are running inside XAMPP and go to http://localhost/phpmyadmin/; import SQL script in clothes-shop/database/sql to create "theclothe55shop" database OR create empty "theclothe55hop" database and run "php artisan migrate" <br>
