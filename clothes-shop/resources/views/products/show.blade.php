        ...
        <div class="info-box">
            ...
            <form x-data="{
                ...
                @if($product->variants->count() > 1)
                    ...
                    <select name="variant_id" x-model="variant_id" class="border rounded px-3 py-2 w-48">
                ...
                <!-- QUANTITY + BUTTONS -->
                <div class="mt-4 flex flex-col gap-4 w-full max-w-md">

                    <input type="number" name="qty" x-model="qty" value="1" min="1"
                        class="border rounded px-3 py-2 w-full">

                    <!-- STOCK STATUS -->
                    <div class="stock-status-box">
                        <div class="stock-indicator is-low flex" x-show="isLowStock()">
                        ...
                        <div class="stock-indicator is-out flex" x-show="isOutOfStock()">
