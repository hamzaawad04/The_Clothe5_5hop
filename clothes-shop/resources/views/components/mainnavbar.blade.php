   ...
   <header class="w-full flex items-center px-6 py-3">
    <div class="w-1/4">
        ...
        <img src="{{ asset('images/mainlogo.jpg') }}" alt="Logo icon" class="h-20 w-auto object-contain" />
    </a>
    </div>
  ...
  <!-- Search -->
       <div class="flex-grow max-w-lg mx-auto">
           <div class="relative">
               ...
               <img src="{{ asset('icons/search.svg') }}" class="w-6 h-6 absolute left-3 top-1/2 -translate-y-1/2" alt="Search icon">
           </div>
       </div>
       <!-- Icons -->
            ...
            @guest
                <button @click = "open = !open">
                 <img src="{{ asset('icons/account.svg') }}" alt="Account" class="w-6 h-6">
                </button>
